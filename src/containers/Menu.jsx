...
function Menu() {
  ...
  const [text, setText] = useState("Найди свою любимую пасту <3");
    ...
    <>
      <div className="left-menu__test">
        ...
        <MenuItem
          url="/"
          name="Все пасты"
          info={`Паст добавлено: ${Pasti.length} `}
        ...
        <MenuItem
          name="Избранное"
          info={`Паст в избранном: ${postsLength}`}
          url="fav"
        ...
        />
        <Divider style={{ width: 100, color: "green" }} />
        <MenuItem
          link
          name="Telegram"
          url="https://tg.com/"
